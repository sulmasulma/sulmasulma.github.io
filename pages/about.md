...
---
- **이후** (2020년 3월~)
  - AWS를 이용한 데이터 엔지니어링에 대해 공부했습니다. [아티스트를 입력하면 관련 아티스트를 추천해 주는 챗봇](https://sulmasulma.github.io/data/2020/08/02/kakaotalk-chatbot3.html)을 통해 데이터 처리를 자동화하고 효율을 높이기 위한 방법을 익히고 있습니다.
  ...
  - 여러 공부를 하던 중, 12월에 **우리카드 디지털** 직무에 합격하게 되었습니다. 데이터 분석, 데이터 엔지니어링, 전략 수립 등 기술과 비즈니스를 넘나들며 저에게 맞는 일을 찾아가고 싶네요
